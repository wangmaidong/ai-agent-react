...
export function OptionButton<T extends iDropdownOption>(
  props: {
    options: T[],
    handleClick?: () => void | Promise<void>,
    children?: any,
  ...
  const onButtonClick = () => {handleClick(activeKey);};
  const onMenuClick: MenuProps["onClick"] = (e) => {handleClick(e.key);};
